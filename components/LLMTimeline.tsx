...
const classes = [
  {
    title: 'Week 1',
    subtitle: 'Introduction to LLMs',
    desc: 'Covered the basics of Large Language Models, their history, and the fundamental architecture of Transformers.',
  ...
  },
  {
    ...
    desc: 'Learned how text can be represented as high-dimensional vectors and how to store them efficiently in dedicated databases.',
    tags: ['Embeddings', 'Vector Search', 'Supabase'],
  ...
  },
  {
    ...
    desc: 'Explored techniques for optimally prompting models, and started implementing Retrieval-Augmented Generation.',
